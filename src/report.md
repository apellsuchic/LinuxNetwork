...
- У меня получилось пропинговать только два адреса: 127.0.0.2, 127.1.0.1. Они пренадлежат локальному сетевому интерфейсу, который работает только в приделах одной системы. Он назвается "LOOPBACK". Остальные адреса не пренадлежат сети localhost.
...
2. Для сети 10.10.0.0/18 возможны следующие ip-адреса шлюзы(gateway): *10.10.0.2, 10.10.10.10, 10.10.1.255*
