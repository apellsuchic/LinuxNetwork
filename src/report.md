...
- >iptables обрабатывает правила последовательно, сверху вниз, и прекращает
  проверку после нахождения первого подходящего правила. Поэтому машина ws1
  не пропинговывается, так как правило с запретом этого действия прописано выше
  правила с разрешением пропинговки.
